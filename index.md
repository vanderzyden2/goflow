...
<h2 id="a-idproductsproductsa"><a id="Products">Products</a></h2>
...
<li>
<p>On the New Product form, enter the product <strong>Name</strong>, which is a mandatory field. Also enter the <strong>Purchase Order Name</strong>, and <strong>Description</strong>.<br>
...
<li>
<p>In the popup window, choose <strong>Group Product</strong> from the drop-down and click the <strong>Next</strong> button.<br>
...
<li>
<p>Check one or both of the boxes to indicate that this product group <strong>Is Sellable</strong> or <strong>Is Purchasable</strong>.<br>
<img src="https://i.ibb.co/Kq35Q98/products-3.png" alt="New Product"></p>
</li>
<li>
...
<li>
<p>Also, enter information for the product group in the including the <strong>Units of Measure</strong> and <strong>Identifiers</strong> tabs.<br>
...
<li>
<p>In the popup window, choose <strong>Kit Product</strong> from the drop-down and click the <strong>Next</strong> button.<br>
